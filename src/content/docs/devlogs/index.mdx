...
This page contains devlogs of the Distinct Errors SMP. It is updated whenever a new devlog is released, and it contains links to all the devlogs released so far.
...
- Added new RP features:
    ...
    <Aside type="caution" title="This is still a work in progress">
        The main base of the character system works, but it's ugly for now, as it uses minecraft legacy colors system. 
        i'll update the colors from time to time to fit out theme more (and also to just use the better color thingies).
    </Aside>
